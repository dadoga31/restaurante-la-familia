...
export default function ReservasClient({ initialReservations }: Props) {
    ...
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <button onClick={refresh} disabled={refreshing}
          className="flex items-center gap-2 px-4 py-2 border border-carbon-600 text-cream-300 hover:text-cream-50 text-sm rounded-lg transition-all disabled:opacity-50">
          <RotateCcw size={15} className={refreshing ? "animate-spin" : ""} /> Actualizar
        </button>
      </div>

      {/* Filters — all in-memory, instant */}
